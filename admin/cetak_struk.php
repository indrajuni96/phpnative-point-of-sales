...
$pdf->Cell(25.5,0.7,"Laporan struk",0,10,'C');
$pdf->ln(1);
$pdf->SetFont('Arial','B',10);
...
$pdf->Cell(4, 0.8, 'Harga Jual', 1, 1, 'C');
$pdf->Cell(4, 0.8, 'jumlah', 1, 2, 'C');
$pdf->Cell(4, 0.8, 'total', 1, 3, 'C');
...
while($lihat=mysqli_fetch_array($query)){
	$pdf->Cell(1, 0.8, $no , 1, 0, 'C');
	$pdf->Cell(4, 0.8, $lihat['barang_id'],1, 0, 'C');
	$pdf->Cell(4, 0.8, "Rp. ".number_format($lihat['harga']), 1, 1,'C');
	$pdf->Cell(4, 0.8, $lihat['jumlah'],1, 2, 'C');
	$pdf->Cell(4, 0.8, "Rp. ".number_format($lihat['total_harga']),1, 3, 'C');
    $no++;
